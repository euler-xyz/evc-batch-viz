export default [
  ...
  { inputs: [], name: "InvalidGovernanceDataSource", type: "error" },
  { inputs: [], name: "InvalidGovernanceMessage", type: "error" },
  { inputs: [], name: "InvalidGovernanceTarget", type: "error" },
  { inputs: [], name: "InvalidUpdateData", type: "error" },
  { inputs: [], name: "InvalidUpdateDataSource", type: "error" },
  { inputs: [], name: "InvalidWormholeAddressToSet", type: "error" },
  { inputs: [], name: "InvalidWormholeVaa", type: "error" },
  { inputs: [], name: "NoFreshUpdate", type: "error" },
  { inputs: [], name: "OldGovernanceMessage", type: "error" },
  { inputs: [], name: "PriceFeedNotFound", type: "error" },
  { inputs: [], name: "PriceFeedNotFoundWithinRange", type: "error" },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "updateDataSize", type: "uint256" },
    ],
    name: "getUpdateFee",
    outputs: [{ internalType: "uint256", name: "feeAmount", type: "uint256" }],
    stateMutability: "view",
  ...
  {
    inputs: [
      { internalType: "address", name: "wormhole", type: "address" },
      {
        internalType: "uint16[]",
  ...
  {
    inputs: [
      { internalType: "uint16", name: "dataSourceChainId", type: "uint16" },
      {
        internalType: "bytes32",
  ...
  {
    inputs: [{ internalType: "bytes", name: "encodedPayload", type: "bytes" }],
    name: "parseAuthorizeGovernanceDataSourceTransferPayload",
    outputs: [
      {
        components: [
          { internalType: "bytes", name: "claimVaa", type: "bytes" },
        ],
        internalType:
          "struct PythGovernanceInstructions.AuthorizeGovernanceDataSourceTransferPayload",
        name: "sgds",
        type: "tuple",
      },
    ],
  ...
  {
    inputs: [
      { internalType: "bytes", name: "encodedInstruction", type: "bytes" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint64", name: "minPublishTime", type: "uint64" },
      { internalType: "uint64", name: "maxPublishTime", type: "uint64" },
    ],
    ...
    outputs: [
      {
        ...
        internalType:
          "struct PythGovernanceInstructions.RequestGovernanceDataSourceTransferPayload",
        name: "sgdsClaim",
        type: "tuple",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType:
          "struct PythGovernanceInstructions.SetWormholeAddressPayload",
        name: "sw",
        type: "tuple",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType:
          "struct PythGovernanceInstructions.UpgradeContractPayload",
        name: "uc",
        type: "tuple",
      },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "bytes[]", name: "updateData", type: "bytes[]" },
      { internalType: "bytes32[]", name: "priceIds", type: "bytes32[]" },
      { internalType: "uint64[]", name: "publishTimes", type: "uint64[]" },
    ],
